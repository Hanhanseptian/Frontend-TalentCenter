<template>
  ...
  >
    ...
    <!-- account information -->
    <b-card v-if="!is_change_password" class="shadow">
      <div class="mb-3 h6">Account Information</div>
      <ValidationObserver v-slot="{ handleSubmit }">
        <form @submit.prevent="handleSubmit(changeAccount)">
          ...
          <!-- action button -->
          <div
            class="float-right clickable hoverable text-talent fs-12 link text-talent"
            @click="is_change_password = true"
          >
            Change Password?
          </div>
          <br />
          <b-button size="sm" class="btn-talent mt-3 float-right" type="submit">
            Save Changes
          </b-button>
        </form>
      </ValidationObserver>
    ...
    <b-card v-else class="shadow">
      <div class="mb-3 h6">Change Password</div>
      <ValidationObserver v-slot="{ handleSubmit }">
        <form @submit.prevent="handleSubmit(changePassword)">
          ...
          <div class="d-flex align-items-center mt-3">
            ...
            <b-button size="sm" class="btn-talent" type="submit">
              Change Password
            </b-button>
          </div>
        </form>
